  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Neon accent colors for LifeNavigator
        neon: {
          purple: "#a855f7",
          magenta: "#ec4899",
          cyan: "#06b6d4",
      ...
      backgroundImage: {
        ...
        "gradient-mesh": "linear-gradient(135deg, rgba(168, 85, 247, 0.1) 0%, rgba(6, 182, 212, 0.1) 50%, rgba(236, 72, 153, 0.1) 100%)",
      },
      boxShadow: {
        ...
        "neon-magenta": "0 0 20px rgba(236, 72, 153, 0.4), 0 0 40px rgba(236, 72, 153, 0.2)",
